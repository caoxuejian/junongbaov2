package com.nxt.nxtapp.common.base64;
...
public class Test {
	...
	public static void main(String[] args) {
		...
		try {
			...
			com.nxt.nxtapp.common.LogUtil.syso("方法-加密后："+new String(encryptResultStr));
			String decryptString=BackAES.decrypt(new String(encryptResultStr),
					skey, 0);
			com.nxt.nxtapp.common.LogUtil.syso("方法-解密后："+decryptString);
...
//		
//			//com.nxt.nxtapp.common.LogUtil.syso("方法二加密后："+new String(encryptResultStr2));
//			////.java将2进制数据转换成16进制parseHexStr2Byte
//			String toByteString=BackAES.parseByte2HexStr(encryptResultStr2);//java将16进制转换为二进制
//			com.nxt.nxtapp.common.LogUtil.syso("方法二加密后转成16进制："+toByteString);
//			
//			
//			// /**将16进制转换成2进制
//
//			byte[] ascToByte=BackAES.parseHexStr2Byte(toByteString);
//			com.nxt.nxtapp.common.LogUtil.syso("方法二解密密后转成二进制："+new String(ascToByte));
//			
//			byte[] decryptString2=BackAES.newdecrypt(ascToByte,skey2);
//			com.nxt.nxtapp.common.LogUtil.syso("方法二解密后："+new String(decryptString2));
//			
		...
		// com.nxt.nxtapp.common.LogUtil.syso("Base64转码后：" + result1);
		//
		// com.nxt.nxtapp.common.LogUtil.syso("============================================");
		// String result2 = Base64.decode(result1, chartCode);
		// com.nxt.nxtapp.common.LogUtil.syso("Base64解码后：" + result2);
