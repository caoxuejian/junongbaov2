...
import com.nxt.ynt.x5view.SecurityJsBridgeBundle;
...
public class X5WebView extends WebView {
	...
	private WebChromeClient chromeClient = new WebChromeClient() {
		...
		/**
		 * 对应js 的�?�知弹框 ，可以用来实现js �? android之间的�?�信
		 */
		@Override
	...
	public X5WebView(Context arg0, AttributeSet arg1) {
		super(arg0, arg1);
		this.setWebViewClientExtension(new X5WebViewEventHandler(this));// 配置X5webview的事件处�?
	...
	/**
	 * 判定当前的prompt消息是否为用于调用native方法的消�?
	 * 
	 * @param msg
	 *            消息名称
	 * @return true 属于prompt消息方法的调�?
	 */
