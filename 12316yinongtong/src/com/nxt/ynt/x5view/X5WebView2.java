...
//			i.setType("*/*");
//			((Activity) (X5WebView2.this.getContext())).startActivityForResult(Intent.createChooser(i, "choose files"),
//					X5WebView2.FILE_CHOOSER);
...
//			if (X5WebView2.isSmallWebViewDisplayed == true) {
//
//				WebView.WebViewTransport webViewTransport = (WebView.WebViewTransport) msg.obj;
//				WebView webView = new WebView(X5WebView2.this.getContext()) {
//
...
//				X5WebView2.this.addView(webView, lp);
...
//			if (X5WebView2.this.isMsgPrompt(arg1)) {
//				if (X5WebView2.this.onJsPrompt(arg2, arg3)) {
//					return true;
//				} else {
//					return false;
//				}
...
//	}
//*/
//	public X5WebView2(Context arg0) {
//		super(arg0);
